    ...
    Dental Clinic
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden sm:inline-flex rounded-full border border-zinc-200 bg-white px-5 py-2.5 text-sm text-zinc-900 shadow-sm hover:border-zinc-400 hover:shadow-md"
          >
            Позвонить
          </a>
          ...
          <button
            onClick={onBook}
            className="rounded-full bg-zinc-900 px-5 py-2.5 text-sm text-white hover:bg-zinc-700"
          >
            Запись
          </button>
