  ...
  return (
    <section id="services" className="relative overflow-hidden py-32">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute left-[-120px] top-[120px] h-[420px] w-[420px] rounded-full bg-[#12c7b7]/15 blur-3xl" />
        <div className="absolute bottom-0 right-[-120px] h-[360px] w-[360px] rounded-full bg-[#12c7b7]/10 blur-3xl" />
      </div>

      <div className="relative mx-auto max-w-7xl px-6">
        <div className="max-w-3xl">
          <span className="inline-flex rounded-full border border-[#12c7b7]/20 bg-[#12c7b7]/10 px-4 py-2 text-xs font-medium uppercase tracking-[0.25em] text-[#0f8f84]">
            Услуги
          </span>
              ...
              {visibleServices.map((service, idx) => {
                ...
                return (
                  <motion.article
                    ...
                    className={
                      service.featured
                        ? "group relative overflow-hidden rounded-[36px] bg-gradient-to-br from-[#12c7b7] via-[#16d6c5] to-[#0fb3a5] p-10 text-white shadow-[0_20px_80px_rgba(18,199,183,0.22)] lg:col-span-2 lg:row-span-2"
                        : "group relative overflow-hidden rounded-[32px] border border-[#12c7b7]/15 bg-white/90 p-8 shadow-[0_10px_40px_rgba(18,199,183,0.08)] backdrop-blur-xl transition-colors duration-300 hover:border-[#12c7b7]/35"
                    }
                  >
                    {service.featured ? (
                      <>
                        ...
                        <div className="relative">
                          ...
                          <div className="mt-10 flex items-center justify-between gap-6">
                            ...
                            <button
                              ...
                              className="rounded-full bg-white px-6 py-3 text-sm font-medium text-[#0f8f84] shadow-lg transition hover:scale-[1.03] hover:bg-[#eafffc]"
                            >
                              Подробнее
                            </button>
                          </div>
                      ...
                      <>
                        <div className="absolute right-[-70px] top-[-70px] h-[170px] w-[170px] rounded-full bg-[#12c7b7]/10 blur-3xl transition-transform duration-700 group-hover:scale-125" />
                        ...
                        <div className="relative">
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <span className="shrink-0 text-sm font-medium text-[#12c7b7]">
                              {service.price}
                            </span>
                          </div>
                          ...
                          <button
                            onClick={() => setSelectedService(service)}
                            className="mt-8 rounded-full border border-[#12c7b7]/20 bg-[#12c7b7]/8 px-5 py-2.5 text-sm font-medium text-[#0f8f84] transition hover:bg-[#12c7b7] hover:text-white"
                          >
                            Подробнее
                          </button>
                        </div>
        ...
        {services.length > 5 && (
          <div className="mt-14 flex justify-center">
            <motion.button
              ...
              className="group relative overflow-hidden rounded-full border border-[#12c7b7]/20 bg-white px-7 py-3 text-sm font-medium text-[#0f8f84] shadow-sm transition-all duration-300 hover:border-[#12c7b7]/40 hover:text-white hover:shadow-lg hover:shadow-[#12c7b7]/20"
            >
              <span className="absolute inset-0 origin-left scale-x-0 bg-[#12c7b7] transition-transform duration-300 group-hover:scale-x-100" />
